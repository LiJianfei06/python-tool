# -*- coding: utf-8 -*-
"""
Created on Thu Oct 11 23:21:02 2018
...
def ResBlock(network,last_name='',block_name='conv2_',block_n=3,num_out=16,downsampling=False,down_method='pooling',use_global_stats='False'):
    ...
    for i in range(1,block_n+1,1):
        ...
        network,last_name=write_prototxt.BatchNorm(network,name_bn=block_name+str(i)+"_bn"+'1',name_scale=block_name+str(i)+"_scale"+'1',
        ...
        network,last_name=write_prototxt.Convolution(network,name=block_name+str(i)+'_2',bottom_name=last_name,top_name=block_name+str(i)+'_2',num_output=16,
        ...
        #Axpy(network,name="Concat1",bottom_name1='',bottom_name2='',bottom_name3='',top_name='')
...
if __name__ == '__main__':
    ...
    with open("train_SE-ResNet_20.prototxt", 'w') as f:
        f.write(str(ResNet_cifar(mode='train',root_path=root_path_train,batch_size=128,block_n=3)))#创建 train.prototxt
    with open("test_SE-ResNet_20.prototxt", 'w') as f:
        f.write(str(ResNet_cifar(mode='test',root_path=root_path_test,batch_size=10,block_n=3)))#创建 train.prototxt
